	...
	public static void main( String[] args ){
		...
		if (diffFromPerfect!=0){
			if (diffFromPerfect==1 && evenOrOdd==1){ // number stopped in top right corner: no additional rows, one additional column
				System.out.println("Lägger till en ny kolumn till höger");
				...
				System.out.println("Lägger till en ny kolumn till vänster");
				System.out.println("1" + " " + (previousSqrt+1));
				cols++;
				...
				System.out.println("Lägger till en ny rad ovanför och en kolumn till vänster");
				cols++;
				rows++;
			} else { // number went into a new row == we add both a col and a row
				System.out.println("Lägger till en ny rad under och en kolumn till höger");
				cols++;
				rows++;
				lastCol = 1;
				lastRow = 1;
